...
export default function ApiTester() {
    ...
    return (
        <div className="tool-shell" style={{ display: 'flex', flexDirection: 'column' }}>
            <style>{`
      ...
      `}</style>
            ...
            <div style={{ padding: '16px 24px', borderBottom: '1px solid var(--border)', background: 'var(--bg-secondary)' }}>
                ...
                <div style={{ display: 'flex', gap: '0' }}>
                    ...
                    />
                    <button className="send-btn" onClick={send} disabled={loading || !url.trim()} style={{ borderRadius: '0 8px 8px 0' }}>
                        {loading ? (
            ...
            {/* Body */}
            <div className="split-2-tight" style={{ flex: 1, minHeight: 0 }}>
                {/* Request Config */}
                <div className="request-pane" style={{ display: 'flex', flexDirection: 'column', minHeight: 0 }}>
